  ...
  return (
    <main className="bg-background text-on-surface font-body selection:bg-primary-container selection:text-white overflow-x-hidden min-h-screen">
      ...
      <div className="pt-32 pb-24 px-6 md:px-12 max-w-4xl mx-auto relative z-10">
        <h1 className="font-headline text-4xl sm:text-5xl font-bold text-white leading-tight tracking-tighter mb-8">Kullanım Koşulları</h1>
        <div className="prose prose-invert prose-lg max-w-none text-slate-300">
          ...
          <h2 className="text-2xl font-bold text-white mt-10 mb-4 font-headline">1. Koşulların Kabulü</h2>
          <p className="mb-6 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-white mt-10 mb-4 font-headline">2. Fikri Mülkiyet Hakları</h2>
          <p className="mb-6 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-white mt-10 mb-4 font-headline">3. Diğer Web Sitelerine Bağlantılar</h2>
          <p className="mb-6 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-white mt-10 mb-4 font-headline">4. Sorumluluğun Sınırlandırılması</h2>
          <p className="mb-6 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-white mt-10 mb-4 font-headline">5. Değişiklikler</h2>
          <p className="mb-6 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-white mt-10 mb-4 font-headline">6. İletişim</h2>
          <p className="mb-6 leading-relaxed">
