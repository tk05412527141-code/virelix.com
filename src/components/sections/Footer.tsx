...
export const Footer = () => {
    return (
        <footer className="bg-[#0b0a1a] w-full py-12 sm:py-20 px-6 sm:px-8 mt-auto border-t border-white/5 relative z-10">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12 max-w-7xl mx-auto font-body leading-relaxed">
                {/* Branding */}
                <div className="col-span-1 md:col-span-1 space-y-6">
                    <div className="text-2xl font-bold text-white font-headline tracking-tighter">Virelix AI</div>
                    <p className="text-slate-400 text-base leading-relaxed">
                        Geleceğin teknolojilerini bugün inşa ediyoruz. Yapay zeka ile sınırları zorlayan çözümler.
                    </p>
                </div>
                ...
                {/* Social */}
                <div>
                    <h5 className="text-white font-bold mb-6 text-lg font-headline">Sosyal Medya</h5>
                    <div className="flex gap-4">
                        <Link 
                            className="h-12 w-12 rounded-full bg-white/5 flex items-center justify-center text-slate-400 hover:text-primary transition-colors border border-white/5 hover:border-primary/20" 
                            href="https://www.linkedin.com/in/tuna-k%C4%B1l%C4%B1%C3%A7-9712ab355/"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                            <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"></path></svg>
                        </Link>
                        <Link className="h-12 w-12 rounded-full bg-white/5 flex items-center justify-center text-slate-400 hover:text-primary transition-colors border border-white/5 hover:border-primary/20" href="#">
